...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'd8d64814-b2d8-47ba-a522-498ff5672909' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('22aa9ff1-26be-4fd8-8c02-2132c1b55a6d');
      cy.get(`[data-cy="name"]`).should('have.value', '22aa9ff1-26be-4fd8-8c02-2132c1b55a6d');
