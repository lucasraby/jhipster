...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '48482406-4999-4600-be1c-4d306cee386c' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('4dd5d4b4-82b7-4a39-ad12-70301132ade5');
      cy.get(`[data-cy="name"]`).should('have.value', '4dd5d4b4-82b7-4a39-ad12-70301132ade5');
